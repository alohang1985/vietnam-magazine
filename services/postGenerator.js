...
async function generate(query, rawResults, region = '', topic = '') {
  ...
  if (geminiKey) {
    const prompt = "절대로 JSON 형식으로 응답하지 마세요. " + "코드블록을 사용하지 마세요. " + "마크다운 본문만 순수 텍스트로 출력하세요. " + "주제: " + query + " " + "참고 자료: " + snippets + " " + "위 주제에 대해 20대 여성 여행 블로거 스타일로 " + "3000자 이상 마크다운 본문만 작성해줘. " + "이모지 포함, 귀엽고 전문적으로.";
    try {
